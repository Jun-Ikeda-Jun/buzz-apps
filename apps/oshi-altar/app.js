...
async function handleFile(file) {
  ...
  try {
    ...
    oshiImage = await blobToImage(blob);
    renderAltar();
...
function renderAltar() {
  ...
  selectedTemplate.render(ctx, W, H, oshiImage);
}
...
btnDownload.addEventListener("click", async () => {
  ...
  downloadBlob(blob, `oshi-altar-${selectedTemplate.id}.png`);
});
